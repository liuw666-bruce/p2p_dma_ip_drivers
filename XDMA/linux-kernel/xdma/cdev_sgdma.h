...
#define DIRECTION_FROM_PHY_ADDR (0)
#define DIRECTION_TO_PHY_ADDR (1)
...
struct xdma_phy_addr_ioctl {
	uint64_t ep_addr;
	uint64_t phy_addr;
	int direction;     //0: from phy mem;   1: to phy mem
	unsigned long len;
};
...
#define IOCTL_XDMA_PHY_ADDR 	_IOW('q', 9, struct xdma_phy_addr_ioctl *)
